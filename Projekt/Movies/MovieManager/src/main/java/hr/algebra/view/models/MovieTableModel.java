...
public class MovieTableModel extends AbstractTableModel{
    ...
    private static final String[] COLUMN_NAMES = {"Id", "Title", "Original title", "Published date", "Genre", "Duration", "Year of release"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 6:
                return movies.get(rowIndex).getYearOfRelease();
            default:
